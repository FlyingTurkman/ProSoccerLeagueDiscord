...
export const JoinAsGoalkeeper: buttonInteractionType = {
    ...
    run: async (client: Client, interaction: Interaction) => {
        ...
        if (check.type == 'solo') {
            if (check.ranked?.bronze?.goalkeepers.includes(user) || check.ranked?.silver?.goalkeepers.includes(user) || check.ranked?.gold?.goalkeepers.includes(user)) {
                await interaction.reply({
                    content: 'You are already in lineup as goalkeepers',
                    ephemeral: true
                })
                return
            }
            ...
            if (userData.soloRankedElo < BRONZE - ELO_GAP) {
                await Lineup.findOneAndUpdate({
                    ...
                    $addToSet: {'ranked.bronze.goalkeepers': user},
                    $pull: {
            ...
            if (userData.soloRankedElo >= BRONZE - ELO_GAP && userData.soloRankedElo < SILVER - ELO_GAP) {
                await Lineup.findOneAndUpdate({
                    ...
                    $addToSet: {'ranked.bronze.goalkeepers': user, 'ranked.silver.goalkeepers': user},
                    $pull: {
                        'ranked.bronze.attackers': user,
                        'ranked.bronze.midfielders': user,
                        'ranked.bronze.defenders': user,
            ...
            if (userData.soloRankedElo > BRONZE - ELO_GAP && userData.soloRankedElo < SILVER - ELO_GAP) {
                await Lineup.findOneAndUpdate({
                    ...
                    $addToSet: {'ranked.silver.goalkeepers': user},
                    $pull: {
                        'ranked.bronze.attackers': user,
                        'ranked.bronze.midfielders': user,
                        'ranked.bronze.defenders': user,
            ...
            if (userData.soloRankedElo >= SILVER - ELO_GAP && userData.soloRankedElo < SILVER) {
                await Lineup.findOneAndUpdate({
                    ...
                    $addToSet: {'ranked.silver.goalkeepers': user, 'ranked.gold.goalkeepers': user},
                    $pull: {
                        'ranked.bronze.attackers': user,
                        'ranked.bronze.midfielders': user,
                        'ranked.bronze.defenders': user,
            ...
            if (userData.soloRankedElo > SILVER + ELO_GAP) {
                await Lineup.findOneAndUpdate({
                    ...
                    $addToSet: {'ranked.gold.goalkeepers': user},
                    $pull: {
                        'ranked.bronze.attackers': user,
                        'ranked.bronze.midfielders': user,
                        'ranked.bronze.defenders': user,
