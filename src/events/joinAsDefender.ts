...
const customId = 'join_as_defender_'


export const JoinAsDefender: buttonInteractionType = {
    customId,
    run: async (client: Client, interaction: Interaction) => {
        ...
        if (check.type == 'solo') {
            if (check.ranked?.bronze?.defenders.includes(user) || check.ranked?.silver?.defenders.includes(user) || check.ranked?.gold?.defenders.includes(user)) {
                await interaction.reply({
            ...
            if (userData.soloRankedElo < BRONZE - ELO_GAP) {
                await Lineup.findOneAndUpdate({
                    ...
                    $addToSet: {'ranked.bronze.defenders': user},
                    $pull: {
            ...
            if (userData.soloRankedElo >= BRONZE - ELO_GAP && userData.soloRankedElo < SILVER - ELO_GAP) {
                await Lineup.findOneAndUpdate({
                    ...
                    $addToSet: {'ranked.bronze.defenders': user, 'ranked.silver.defenders': user},
                    $pull: {
                        'ranked.bronze.attackers': user,
                        'ranked.bronze.midfielders': user,
                        //'ranked.bronze.defenders': user,
            ...
            if (userData.soloRankedElo > BRONZE - ELO_GAP && userData.soloRankedElo < SILVER - ELO_GAP) {
                await Lineup.findOneAndUpdate({
                    ...
                    $addToSet: {'ranked.silver.defenders': user},
                    $pull: {
                        'ranked.bronze.attackers': user,
                        'ranked.bronze.midfielders': user,
                        'ranked.bronze.defenders': user,
            ...
            if (userData.soloRankedElo >= SILVER - ELO_GAP && userData.soloRankedElo < SILVER) {
                await Lineup.findOneAndUpdate({
                    ...
                    $addToSet: {'ranked.silver.defenders': user, 'ranked.gold.defenders': user},
                    $pull: {
                        'ranked.bronze.attackers': user,
                        'ranked.bronze.midfielders': user,
                        'ranked.bronze.defenders': user,
            ...
            if (userData.soloRankedElo > SILVER + ELO_GAP) {
                await Lineup.findOneAndUpdate({
                    ...
                    $addToSet: {'ranked.gold.defenders': user},
                    $pull: {
                        'ranked.bronze.attackers': user,
                        'ranked.bronze.midfielders': user,
                        'ranked.bronze.defenders': user,
